...
# Welcome to CSC413: Neural Networks and Deep Learning!

## Introduction: Instructors

**Akshay Gadi Patil** (LEC0101, Tuesdays, 5-7pm)

**Florian Shkurti** (LEC0102, Thursdays, 3-5pm)

**Randy Hickey** (LEC0103, Thursdays, 1-3pm)

Please use Piazza for course-related questions. Course delivery details are on Quercus.
...
-   We are trying active learning:
    ...
    -   you come to class prepared to ask questions 
...
-   Mostly supervised learning
    ...
    -   Recurrent Neural Networks and Tranformers for sequences 
